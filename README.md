...
[![NPM Version](https://img.shields.io/badge/npm-coming_soon-blue)](https://www.npmjs.com/package/@clawreg/core)
...
client.registerProvider(new WhatsAppProvider({ phoneNumber: '+15555550123' }));
